...
function SideBar() {
    ...
    function onLogoutClick() {
        doLogout(localStorage.getItem('token'))
            .then(response => clearAndRedirect())
            .catch(error => {
                console.error(error);
                clearAndRedirect();
            })
            ...
            <nav id="sidebarMenu" className="sidebar d-lg-block bg-gray-800 text-white collapse" datasimplebar="true">
                <div className="sidebar-inner px-4 pt-3">
                    ...
                    <ul className="nav flex-column pt-3 pt-md-0">
                        <li className="nav-item">
                            <Link to="/dashboard" className="nav-link d-flex align-items-center">
                                <span className="sidebar-icon">
                                    <img src="/img/favicon/favicon-32x32.png" height="20" width="20" alt="Food Logo" />
                                </span>
                                <span className="mt-1 ms-1 sidebar-text">Food 1.0</span>
                            </Link>
                        </li>
                        <SideBarItem to="/product" text="Cadastro">
                        ...
                        <SideBarItem to="/edit" text="Editar">
