                    ...
                    <div className="col-12 d-flex align-items-center justify-content-center">
                        <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div className="text-center">
                                <img src="/img/favicon/mstile-150x150.png" alt="Food" width={64} />
                            </div>
                            <div className="text-center text-md-center mb-4 mt-md-0">
                                <h1 className="mb-0 h3">Faça o login em nossa plataforma</h1>
                            </div>
                            <form action="#" className="mt-4" onSubmit={onSubmit} >
                                <div className="form-group mb-4">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="email" className="form-control" placeholder="example@gmail.com" id="email" autoFocus required onChange={onChangeInput} />
                                    </div>
                                </div>
                                <div className="form-group">
                                    <div className="form-group mb-4">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="password" placeholder="Sua senha" className="form-control" id="password" required onChange={onChangeInput} />
                                        </div>
                                    </div>
                                </div>
